...
const game_action_list = new GameActionList([
    ...
    {
        id: 'naked3.1_act',
        action: GameAction.polyActs(GameAction.genAddPassengerAct('jacob_psg'), GameAction.genActivateSignatureAct('naked.mask_sig'), GameAction.genStepPlotThredAct('naked_plt'))
    },
    {
        id: 'naked3.2_act',
